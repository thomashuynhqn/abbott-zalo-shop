...
const PlacedOrder = ({ order }) => {
  const { cart, createdAt, selectedDiscount, total, shipping, shop, address } =
    order;
    ...
    <Card className="discount-card" inset>
      ...
      <div className="discount-summary">
        ...
        <div className="d-flex">
          ...
          {selectedDiscount && (
            <Text className="text-secondary">&nbsp;- {selectedDiscount}</Text>
          )}
        </div>
        <Button fill responsive onClick={reOrder}>
          Đặt lại
        </Button>
      </div>
    </Card>

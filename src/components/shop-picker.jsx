  ...
  return (
    ...
    >
      ...
      <div className="description">
        ...
        <Text>
          Mở bán từ {padZero(open.hour)}h{padZero(open.minute)} -{" "}
          {padZero(close.hour)}h{padZero(close.minute)}
              ...
              <Box>
                <Row>
                  ...
                  <Col width="30" className="text-right">
                    <Link className="text-primary">Tìm gần nhất</Link>
                  </Col>
                </Row>
              </Box>
            </ActionsLabel>

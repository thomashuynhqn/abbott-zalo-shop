      ...
      {discounts.length > 0 ? (
        <Box m={4}>
          ...
          {filteredDiscounts.map((discount) => (
            <Box key={discount.code} mx={0} my={2}>
        ...
        <Box className="d-flex h-100 h-center v-center text-center">
          <Box>
            <Text className="text-secondary my-4">
              Rất tiếc, bạn chưa có mã ưu đãi nào!
            </Text>
            <Button typeName="secondary" responsive onClick={backHome}>
              Trở lại
            </Button>
          </Box>
        </Box>
